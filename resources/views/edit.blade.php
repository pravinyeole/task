                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('contact_reg') }}" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="middle_name" type="text" class="form-control @error('middle_name') is-invalid @enderror" name="middle_name" value="{{ $data->middle_name }}" autocomplete="middle_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_optional" type="text" class="form-control @error('phone_optional') is-invalid @enderror" name="phone_optional" value="{{ $data->phone_optional }}" autocomplete="phone_optional" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="image" type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ $data->image }}" autocomplete="image">
                                ...
                                @enderror
                                @if(!empty($data->image))
                                <a href="{{asset($data->image)}}" download >Download</a>
                                @endif
